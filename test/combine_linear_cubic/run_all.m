...
disp(sigma_add);
save_string=sprintf('simulations/data_combine_T%d_dt%0.0e_Nnodes%d_Nincoming%d_sigma%d-%d',...
...
for is=1:size(pre_s,2)
    sigma=pre_s(is);   
    for irep=1:Ntotal
        [x_all, x_tau_all, dt_x_all, dt_x_all_v2, adjacency, betas]=simulate_mixeddecay_tseries(...
